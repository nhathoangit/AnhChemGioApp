...
import com.example.jerem.anhchemgioapp.utils.BitmapUtils;
...
public class ProfileActivity extends BaseAuthActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rootFire = FirebaseDatabase.getInstance().getReference("users");
    ...
    void onAuthentication(FirebaseAuth firebaseAuth) {
        ...
        userChild.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Glide.with(ProfileActivity.this).load(user.getAvatar()).into(imgProfile);
            }
        ...
        switch (id) {
            case R.id.action_save:
                ...
                FirebaseDatabase.getInstance().getReference("users").child(fUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        User user = dataSnapshot.getValue(User.class);
                        user.setDisplayName(edtFullName.getText().toString());
                ...
                try {
                    ...
                    uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            DatabaseReference userChild = rootFire.child(fUser.getUid());
                            userChild.child("avatar").setValue(url);
